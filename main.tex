...
\subsection{强化学习}
强化学习是一个快速发展的领域，处于机器学习和控制理论的交叉点，其中智能体学习在复杂的环境进行交互以实现目标[1,2]。
深度强化学习[3-9]最近被证明能够在几个具有挑战性的任务中实现人类水平或超人类的表现，包括玩视频游戏[10,11]和策略游戏[12-14]。
深度强化学习也越来越多地用于科学和工程应用，
包括用于药物发现[15]、机器人操作[16]、自动驾驶[17]和无人机赛车[18]、流体流动控制[19-25]和聚变控制[26]。

尽管取得了上述进展，深度强化学习解决方案通常需要巨大的计算资源来训练和泛化，
并且它们通常缺乏在许多应用中至关重要的可解释性。
许多强化学习策略背后的算法与优化和最优控制理论[2]中的
贝尔曼方程（Bellman Equation）及其连续形式汉密尔顿-雅可比-贝尔曼（Hamilton-Jacob-Bellman）方程密切相关。
...
最近，Koopman算子在缓解未知动力学下非线性控制的这种困难方面表现出巨大的潜力。
