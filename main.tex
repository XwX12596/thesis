...
%中文摘要
\ZhAbstract{在这篇文章中，我们探索了如何通过改进强化学习框架来更好地控制非线性系统。
...
最后，分两步提出了深度Koopman算子辅助的最大熵强化学习算法，具体通过改写贝尔曼方程并将价值估计提升到嵌入空间，
...
%英文摘要
\EnAbstract{
  In this article, we explore how to more precisely control nonlinear systems by improving the reinforcement learning framework.
